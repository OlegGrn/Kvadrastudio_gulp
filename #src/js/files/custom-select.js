...
class CustomSelect {
	...
	show() {
		document.querySelectorAll(SELECTOR_ACTIVE).forEach(select => {
			// if (select.classList.contains(CLASS_NAME_ACTIVE)) {
			// 	console.log(select);
			// }
		...
		//_slideDown(this._elRoot.querySelector(".select__dropdown"));


	}
	hide() {
		this._elRoot.classList.remove(CLASS_NAME_ACTIVE);
		//console.log(this._elRoot.querySelector(".select__dropdown"));
		//_slideUp(this._elRoot.querySelector(".select__dropdown"));
...
// const select1 = new CustomSelect('#select1', {
// 	name: 'featured', // значение атрибута name у кнопки
// 	targetValue: 'featured', // значение по умолчанию
//!   list: [
// 		['featured', 'featured'],
// 		['sale', 'sale'],
// 		['hits', 'hits'],
...
// 	name: 'arrivals', // значение атрибута name у кнопки
// 	targetValue: 'arrivals', // значение по умолчанию
//!   options: [
// 		['arrivals', 'arrivals'],
// 		['new', 'new'],
// 		['sale', 'sale'],
